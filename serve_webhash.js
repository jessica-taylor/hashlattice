...
ChildProcess.exec('node_modules/.bin/browserify ./lib/weblib.js -o webhash/weblib.js && node_modules/.bin/browserify ./lib/webhash.js -o webhash/webhash.js', function(err, stdout, stderr) {
  if (stdout || stderr) {
