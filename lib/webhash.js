(function() {
  ...
  function getResponseByPath(pathname, callback) {
    ...
    if (!match) {
      ...
      var hl = {
        path: restPath,
        putHashData: new Code.AsyncFunction(_.bind(window.server.putHashData, window.server)),
        putHashDataSplit: new Code.AsyncFunction(_.bind(window.server.putHashDataSplit, window.server)),
        getVar: new Code.AsyncFunction(_.bind(window.server.getVar, window.server)),
        putVar: new Code.AsyncFunction(_.bind(window.server.putVar, window.server)),
        getLocal: new Code.AsyncFunction(_.bind(localStore.get, localStore)),
        putLocal: new Code.AsyncFunction(_.bind(localStore.put, localStore)),
        currentTime: new Date().getTime(),
        genKeyPair: new Code.AsyncFunction(function(cb) {
