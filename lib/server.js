...
Server.prototype._rawEvalComputation = function(hash, comp, callback) {
  ...
  var api = {
    cl: CompLib,
    getHash: U.bind(self.getHash, self),
    getHashData: U.bind(self.getHashData, self),
    evalComputation: U.bind(self.evalComputation, self)
  };
    ...
    merge: function(varSpec, value1, value2, callback) {
      getVarObj(varSpec, function(err, varObj) {
        if (err) {
          ...
          varObj.merge(value1, value2, callback);
        }
      });
    }
  };
