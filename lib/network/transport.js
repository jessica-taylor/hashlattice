...
function UdpTransport(options) {
  ...
  // Defaults to both.
  self.peerMethods = {}
  self.bootstraps = options.bootstraps || [];
}
...
UdpTransport.prototype.getBootstraps = function(callback) {
  var self = this;
  process.nextTick(function() { callback(null, self.bootstraps); });
};
