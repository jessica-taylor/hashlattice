...
function Node(kwargs) {
  ...
  // TODO Figure out how to initialize peerset.... What does the first peer do?
  /*self.getSelfPeer(function(sp) {
...
Node.prototype.getSelfPeer = function(callback) {
  ...
  if (self.selfPeer) {
    ...
    // TODO Don't use a peerSet here! This is called when we're creating a
    // peerSet. Instead, use this or your bootstraps.
